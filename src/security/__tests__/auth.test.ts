...
describe("AuthManager", () => {
  ...
  it("should register provider successfully", () => {
    ...
    expect(mockLogger.info).toHaveBeenCalledWith("Registered auth provider: test");
  });
  ...
  it("should authenticate with existing provider", async () => {
    ...
    expect(mockLogger.debug).toHaveBeenCalledWith("Authentication succeeded for provider: test");
  });
  ...
  it("should handle authentication failure", async () => {
    ...
    expect(mockLogger.debug).toHaveBeenCalledWith("Authentication failed for provider: test");
  });
  ...
  it("should handle non-existent provider during authentication", async () => {
    ...
    expect(mockLogger.error).toHaveBeenCalledWith("Auth provider not found: non-existent");
  });
  ...
  it("should validate token with existing provider", async () => {
    ...
    expect(mockLogger.debug).toHaveBeenCalledWith("Token validation succeeded for provider: test");
  });
  ...
  it("should handle token validation failure", async () => {
    ...
    expect(mockLogger.debug).toHaveBeenCalledWith("Token validation failed for provider: test");
  });
  ...
  it("should revoke token with existing provider", async () => {
    ...
    expect(mockLogger.debug).toHaveBeenCalledWith("Revoked token for provider: test");
  });
});
